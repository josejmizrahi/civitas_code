      ...
      <header className="sticky top-0 z-50 border-b bg-background/80 backdrop-blur-sm">
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 sm:h-16 sm:px-6">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold tracking-tight sm:text-xl">Civitas</span>
          </Link>
            ...
            <div className="flex flex-col items-center text-center lg:flex-row lg:items-start lg:text-left lg:gap-8">
              ...
              <div className="flex-1">
                ...
                <p className="mt-2 text-sm text-muted-foreground leading-relaxed sm:text-base">
                  ...
                  el motor de reglas configurable y la vision a largo plazo de Civitas como infraestructura
                  para network states.
                </p>
