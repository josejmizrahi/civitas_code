...
INSERT INTO communities (id, name, slug, type, config, rules) VALUES
  ('c0000000-0000-0000-0000-000000000001', 'Residencial Las Palmas', 'las-palmas', 'residential',
   ...
   '{"governance": {"default_quorum": 0.5, "default_majority": 0.5, "delegation_enabled": true, "proposal_rights": ["admin","comite_vigilancia","tesorero","miembro"], "cool_down_hours": 48, "auto_execution_enabled": false}, "treasury": {"mode": "import", "currency": "MXN", "admin_spending_limit": 50000, "require_vote_above": 50000, "clabe": null, "bank_name": null, "beneficiary_name": null, "payment_reference_prefix": "RLP-", "auto_reconciliation": false, "collection_reminder_days": 5}, "identity": {"payment_to_vote_enabled": true, "grace_period_months": 2, "auto_restore_on_payment": true, "delinquent_restrictions": ["vote","propose"]}}'::jsonb),
